                                ...
                                <form method="POST" action="{{ route('password.store') }}">
                                    ...
                                    <div>
                                        ...
                                        <input type="email" name="email" class="form-control"
                                            id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $request->email }}">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center mt-4">
                                        <button type="submit" class="btn btn-primary w-100 py-8 fs-4 mb-4 rounded-2" style="margin-top: 20px;">Reset Password</button>
                                    </div>
                                </form>
                            </div>
                        </div>
